<?php if ($spots === []): ?>
<section class="screen-message"><h1>印刷できるスポットがありません</h1><p>先にスポットを登録してください。</p></section>
<?php else: ?>
...
<article class="print-page spot-page">
    ...
    <aside class="browser-notice compact"><p>普段使用する通常ブラウザで開き、イベント中は毎回同じブラウザをご利用ください。</p><p>iPhoneは「コードスキャナー」ではなく、標準カメラからSafariで開いてください。</p></aside>
</article>
<?php endforeach; ?>
<?php endif; ?>
